...
];// Frase de cada dia do mês
var data_atual = new Date();
var numero_escolhido = data_atual.getDate();//Selecionando o número do dia de hoje

console.log(`Hoje é dia ${numero_escolhido} e a frase do dia é: ${frases_do_dia[numero_escolhido]}`)