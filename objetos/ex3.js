...
var tamanho_colecao = curiosidades_chuck_norris.length;// quantidade de curiosidadedes dentro do array
var numero_sorteado = Math.floor(Math.random() * tamanho_colecao);// Variavel que recebe um número aleatório

var curiosidade_escolhida = curiosidades_chuck_norris[numero_sorteado];// Selecionando uma curiosidade
